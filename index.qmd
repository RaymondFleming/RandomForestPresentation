...
-   Increased accuracy
     - Instead of one decision tree, Random Forest creates multiple decision trees.
     - As more trees are added, the decision boundary becomes more accurate and stable.
     - Useful when handling complex datasets and/or noisy data. 
...
-   Prediction using a combination of random forests leads to a better accuracy on all metrics
:::
...
```
-   Range is the most important feature to predict Group Status followed by Habitat Loss and Growth Form are also important features
