...
## Random Feature Selection {.smaller} (common improvements continued?)
...
## Decision Tree and Cross Validation {.smaller}
...
## Feature Associations {.smaller} (clean up wording)
...
## Data Preparation {.smaller} Add example of data then factorized
```{r}
#| echo: FALSE
#| code-fold: FALSE
#| output: false
...
average_importance <- Reduce("+", importances_list) / 
                      length(importances_list)
...
::: {.absolute top="100" left="0" width="500" height="175"}
$\text{Accuracy}=\frac{\sum{\left(\text{Actual Label} = \text{Predicted Label}\right)}}{\text{Label Count}}$
:::

::: {.absolute top="225" left="0" width="500" height="175"}
$\text{Recall}\quad \;=\frac{\text{True Positives}}{\text{True Positives} + \text{False Negatives}}$
:::

::: {.absolute top="350" left="0" width="500" height="175"}
$\text{Precision}=\frac{\text{True Positives}}{\text{True Positives}+\text{False Positives}}$
:::

::: {.absolute top="475" left="0" width="500" height="175"}
$\text{F1}\qquad \;=\frac{2*(\text{Precision}*\text{Recall})}{\text{Precision}+\text{Recall}}$
:::
